...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Room Locator</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Room Locator</div>
          <div class="intro-heading text-uppercase">Find Your Room Together!<br></div>
        </div>
      </div>
    </header>
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">&copy; Room Locator - <?php echo date("Y"); ?></span>
          </div>
          <div class="col-md-4">
